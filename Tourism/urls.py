...
urlpatterns = [
    ...
    re_path(r'about-us.html/', include('apps.aboutus.urls')),
    re_path(r'contact-us.html/', include('apps.contact.urls')),
    re_path(r'faq.html/', include('apps.faq.urls')),
    re_path(r'feedback.html/', include('apps.feedback.urls')),
]
